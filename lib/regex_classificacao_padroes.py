...
Observação 3:
Grupo de não-captura (?:) diz respeito à forma de como o motor de busca casa os valores
e nada interfere no poder computacional, continua sendo Linguagem Regular (tipo 3).
'''